    ...
    <div class="container bg-primary">
        ...
        <div class="row">
            <div class="col-lg-2 col-md-3 col-sm-3">
                <div class="links bg-primary">
                  <ul>
                      ...
                      <a href="rejected_leaves.php"><li id="active"><i class="fa fa-times"></i> Rejected Leaves</li></a>
            ...
            <div class="col-lg-10 col-md-9 col-sm-9">
                <h1 class="header">Rejected Leaves</h1>
                <div class="main">
                <table class="table table-striped">
                    ...
                    <?php
                            ...
                            $sql = "SELECT id, staff_id, leave_type, start, end, status from tbl_apply where status = 'decline'";
