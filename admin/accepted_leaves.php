            ...
            <div class="col-lg-2 col-md-3 col-sm-3">
                <div class="links bg-primary">
                  <ul>
                      ...
                      <a href="accepted_leaves.php"><li id="active"><i class="fa fa-check"></i> Accepted Leaves</li></a>
            ...
            <div class="col-lg-10 col-md-9 col-sm-9">
                ...
                <table class="table table-striped">
                    ...
                    <?php
                            ...
                            $sql = "SELECT id, staff_id, leave_type, start, end from tbl_apply where status = 'Accept'";
                            ...
                            if($result){
                                if(mysqli_num_rows($result) > 0){
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>'.$row['end'].'</td>
                                            <td>
                                                <i class="fa fa-check" style="color: green">Accepted</i>
                                            </td>
                                          <tr>';
                                }else{
                                    echo '<tr>
