    ...
    <div class="container bg-primary">
        ...
        <div class="row">
            <div class="col-lg-2 col-md-3 col-sm-3">
                <div class="links bg-primary">
                 <ul>
                      ...
                      <a href="pending_leaves.php"><li id="active"><i class="fa fa-question"></i> Pending Leaves</li></a>
            ...
            <div class="col-lg-10 col-md-9 col-sm-9">
                <h1 class="header">Pending Leaves</h1>
                <div class="main">
                <table class="table table-striped">
                    ...
                    <?php
                            ...
                            $sql = "SELECT staff_id, leave_type, start, end, status from tbl_apply where status = 'Pending'";
                                ...
                                if(mysqli_num_rows($result) > 0){
                                    while($row = mysqli_fetch_assoc($result)){
                                        echo '<tr>
                                                ...
                                                <td>'.$row['end'].'</td>
                                                <td>
                                                    <i class="fa fa-question" style="color: grey"> Pending</i>
                                                </td>
                                            <tr>';
                                    }
                                }else{
